...
public class ParcelamentoMapper {
    ...
    public ParcelamentoModel mapToModel(ParcelamentoDTO parcelamentoDTO) {
    ...
    public ParcelamentoDTO mapToDTO(ParcelamentoModel parcelamentoModel) {
        ...
        parcelamentoDTO.setValorParcelado(parcelamentoModel.getValorParcelado()); // ← agora vai aparecer!
